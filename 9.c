...
// Functon to add a three-address code line to the array
...
// Functon to perform basic optmizatons on three-address code
void optmizeCode() {
...
// Functon to print the optmized three-address code
void printOptmizedCode() {
 for (int i = 0; i < codeCount; i++) {
 if (code[i].op == '=') {
